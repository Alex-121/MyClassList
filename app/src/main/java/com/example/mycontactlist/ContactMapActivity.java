...
public class ContactMapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, com.google.android.gms.location.LocationListener {
    ...
    private void disableMap() {
        ImageButton editList = (ImageButton) findViewById(R.id.imageButtonMap);
    ...
    if (contacts.size() >0) {
        ...
        for(int i = 0; i < contacts.size(); i++) {
            ...
            gMap.addMarker(new MarkerOptions().position(point).title(currentContact.getContactName() + " " + currentContact.getPhoneNumber()).snippet(address).icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_marker_30)));
        }
    ...
    private void initExerciseButton() {
        Button exercise = (Button) findViewById(R.id.buttonExercise);
        exercise.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ContactMapActivity.this, Exercise.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (accelerometerValues != null && magneticValues != null) {
                ...
                if(success) {
                    ...
                    else if (azimut >= 135 && azimut < 255) {direction = "S";}
                    else {direction = "E";}
